 ...
 * @author Profesores PPROG
 * @param str Cadena de caracteres referido al comando
 * @return No devuelve un valor especifico por ser una funcion de tipo void
 */
 ...
 * @param x entero
 * @param y entero
 * @param width entero con la anchura determinada
 * @param height entero con la altura
 ...
 * @author Profesores PPROG
 * @param area Puntero al area que se refiere
 * @return No devuelve un valor especifico por ser una funcion de tipo void
 */
