...
* @author Javier Martin
* @param set Puntero al Set que queremos destruir
...
* @author Javier Martin
* @param set Puntero al Set
* @param id el Id que queremos añadir
...
* @author Javier Martin
* @param set Puntero al Set
* @param id el Id que queremos eliminar
...
* @author Javier Martin
* @param set Puntero al Set
* @param i entero con la posicion del id que queremos en el array
...
* @author Javier Martin
* @param set Puntero al Set que se quiere imprimir
