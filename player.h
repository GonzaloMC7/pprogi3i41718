...
* @author Gonzalo Martinez
* @param pl El Player creado anteriormente
...
* @author Gonzalo Martinez
* @param pl El Player creado anteriormente
* @param name un char con el nombre que queremos asignarle al Player
...
* @author Gonzalo Martinez
* @param pl El Player creado anteriormente
* @param id Id que queremos asignarle al Player
* @return OK si se ha asignado correctamente y ERROR si no se ha asignado correctamente
*/
...
* @author Gonzalo Martinez
* @param pl El Player creado anteriormente
* @param location Id del espacio con la localización que queremos asignarle al Player
* @return OK si se ha asignado correctamente y ERROR si no se ha asignado correctamente
*/
