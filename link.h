 ...
 * @brief Crea un link
 * @author Gonzalo Martinez
 * @param id El id que le vamos a asignar al link a crear
 ...
 * @author Gonzalo Martinez
 * @param l El Link creado anteriormente
 ...
 * @author Gonzalo Martinez
 * @param fp fichero donde se imprime
 * @param l link que se va a imprimir
 ...
 * @brief Asigna un Id al link
 * @author Gonzalo Martinez
 * @param l El Link creado anteriormente y
 * @param id el Id a asignar
 ...
 * @brief Asigna un Id al link
 * @author Gonzalo Martinez
 * @param l El Link creado anteriormente y el Id a asignar
 * @param value Booleano con el valor que se le quiere asignar al link(abierto o cerrado)
